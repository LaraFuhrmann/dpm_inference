...
def main(freads_in, fref_in, output_dir, n_starts, K, alpha0, alphabet = 'ACGT-'):
    ...
    """
    if os.path.exists(output_dir+'debug/')==False: # Check whether the specified path exists or not
        os.makedirs(output_dir+'debug/')
    if os.path.exists(output_dir+'corrected/')==False: # Check whether the specified path exists or not
        os.makedirs(output_dir+'corrected/')
    if os.path.exists(output_dir+'support/')==False: # Check whether the specified path exists or not
        os.makedirs(output_dir+'support/')
    """
